...
**Tabla K1. Coordenadas geográficas y período de monitoreo de las cinco estaciones permanentes CARICOMP del INVEMAR sobre la CGSM. Las coordenadas reportadas son las nominales del DwC-A (Beltrán et al. 2022); para los análisis del cuerpo principal se aplicó adicionalmente el protocolo de reubicación al mapa de distribución global de manglar de Giri et al. (2011) descrito en el Anexo E.**
